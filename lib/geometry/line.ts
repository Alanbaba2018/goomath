...
export default class Line {
   ...
   * @param v1 直线终点
   */
  public static getPedalPointOfLine(pt: XY, v0: XY, v1: XY): Vector2 {
   ...
   * @param v1 直线终点
   */
  public static getDistanceOfPtToLine(pt: XY, v0: XY, v1: XY) {
    const vec0: Vector2 = new Vector2(pt.x - v0.x, pt.y - v0.y);
    const vec1: Vector2 = new Vector2(v1.x - v0.x, v1.y - v0.y);
   ...
   * @param {Line} line
   */
  public static isPointAtLine(pt: XY, line: Line): boolean {
    return false;
  }
  /**
   * 判断两条直线是否平行(包含共线)
   ...
   * @param {Line} line2
   */
  public static isParalled(line1: Line, line2: Line): boolean {
   ...
   * @param {Line} line2
   */
  public static isCollinear(line1: Line, line2: Line): boolean {
    const dir1: Vector2 = line1.getDirection();
   ...
   * @param {Line} line2
   */
  public static isInsersect(line1: Line, line2: Line): boolean {
   ...
   * @param {Line} line2
   */
  public static getInsersectPt(line1: Line, line2: Line) {
   ...
   * @param {Line} line2
   */
  public static isInsersectOfSegment(line1: Line, line2: Line): boolean {
